...
const MultiStepFrom = () => {
  return (
    <div className='sm:flex' >
        ...
        <div className='sm:ml-36 sm:mr-64 pt-10'>
        <h1 className='text-black text-h500-T '>Publicacion</h1>
        <p className='text-primary-gray mb-8'>Informacion basica</p>
          ...
          <div className=' mt-6'>
           <select name="Tipo" id="" className='w-full h-12 rounded-lg border-gray border-solid border-2'>
          ...
          <div className='mt-6' >
            <fieldset className='border-solid border-2 rounded-lg w-full h-32 border-primary-gray'>
              ...
              <textarea className='w-full overflow-hidden outline-none resize-none' name="descripcion" id="" rows={4} maxLength={300}></textarea>
            </fieldset>
          </div>
          <div >
            <fieldset className='border-solid border-2 overflow-hidden rounded-lg w-full h-14 border-primary-gray'>
